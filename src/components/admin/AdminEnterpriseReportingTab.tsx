        ...
        <div style={{ display: "flex", gap: "1.25rem", flexWrap: "wrap" }}>
          <div>
            ...
            <select
              ...
              style={{ padding: "0.45rem 0.85rem", backgroundColor: "rgba(15, 23, 42, 0.6)", border: "1px solid rgba(255, 255, 255, 0.12)", borderRadius: "0.375rem", color: "rgb(var(--color-text))", fontSize: "0.85rem", outline: "none" }}
            >
              <option value="Last 30 Days" style={{ background: "rgb(var(--color-card))" }}>Last 30 Days</option>
              <option value="This Quarter" style={{ background: "rgb(var(--color-card))" }}>This Quarter</option>
              <option value="Year to Date" style={{ background: "rgb(var(--color-card))" }}>Year to Date</option>
            </select>
          </div>
          ...
          <div>
            ...
            <select
              ...
              style={{ padding: "0.45rem 0.85rem", backgroundColor: "rgba(15, 23, 42, 0.6)", border: "1px solid rgba(255, 255, 255, 0.12)", borderRadius: "0.375rem", color: "rgb(var(--color-text))", fontSize: "0.85rem", outline: "none" }}
            >
              <option value="ALL" style={{ background: "rgb(var(--color-card))" }}>All Departments</option>
              {departments.map((d: any) => (
                <option key={d._id || d.id} value={d._id || d.id} style={{ background: "rgb(var(--color-card))" }}>{d.name}</option>
              ))}
            </select>
          </div>
          ...
          <div>
            ...
            <select
              ...
              style={{ padding: "0.45rem 0.85rem", backgroundColor: "rgba(15, 23, 42, 0.6)", border: "1px solid rgba(255, 255, 255, 0.12)", borderRadius: "0.375rem", color: "rgb(var(--color-text))", fontSize: "0.85rem", outline: "none" }}
            >
              <option value="ALL" style={{ background: "rgb(var(--color-card))" }}>All Budget Items</option>
              <option value="TRAVEL" style={{ background: "rgb(var(--color-card))" }}>Travel & Flights</option>
              <option value="SAAS" style={{ background: "rgb(var(--color-card))" }}>SaaS Subscriptions</option>
            </select>
          </div>
        </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "1.5rem", marginBottom: "2rem" }}>
            ...
            {deptUtilization.map((d: any, idx: number) => (
              <div key={idx}>
                <div style={{ display: "flex", justifyContent: "space-between", fontSize: "0.8rem", marginBottom: "0.25rem" }}>
                  ...
                  <span style={{ color: "rgb(var(--color-text-muted))" }}>₦ {d.spent.toLocaleString()} / ₦ {(d.budget / 1000000).toFixed(1)}M ({d.pct}%)</span>
                </div>
        ...
        <div className="glass-panel" style={{ padding: "1.5rem", backgroundColor: "rgb(var(--color-card))", borderRadius: "0.75rem" }}>
          ...
          <div style={{
            ...
            borderBottomColor: "rgb(var(--color-text-dim))",
            ...
            <div style={{ fontSize: "1.4rem", fontWeight: "800", color: "rgb(var(--color-text))" }}>91</div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.5rem", fontSize: "0.78rem" }}>
            <span style={{ color: "rgb(var(--color-text-muted))", display: "flex", alignItems: "center", gap: "0.3rem" }}>
            ...
            <span style={{ color: "rgb(var(--color-text-muted))", display: "flex", alignItems: "center", gap: "0.3rem" }}>
              <span style={{ width: "8px", height: "8px", borderRadius: "50%", backgroundColor: "rgb(var(--color-text-dim))" }} /> Pending (12)
            </span>
            <span style={{ color: "rgb(var(--color-text-muted))", display: "flex", alignItems: "center", gap: "0.3rem" }}>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.85rem" }}>
            ...
            <tbody>
              <tr style={{ borderBottom: "1px solid rgba(255, 255, 255, 0.05)" }}>
                <td style={{ padding: "0.75rem 0", color: "rgb(var(--color-text))", fontWeight: "600" }}>Engineering</td>
                <td style={{ textAlign: "right", fontWeight: "700", color: "rgb(var(--color-text))" }}>₦ 800,000</td>
              </tr>
              <tr style={{ borderBottom: "1px solid rgba(255, 255, 255, 0.05)" }}>
                <td style={{ padding: "0.75rem 0", color: "rgb(var(--color-text))", fontWeight: "600" }}>Marketing</td>
                <td style={{ textAlign: "right", fontWeight: "700", color: "rgb(var(--color-text))" }}>₦ 1,200,000</td>
              </tr>
              <tr style={{ borderBottom: "1px solid rgba(255, 255, 255, 0.05)" }}>
                <td style={{ padding: "0.75rem 0", color: "rgb(var(--color-text))", fontWeight: "600" }}>Operations</td>
                <td style={{ textAlign: "right", fontWeight: "700", color: "#ef4444" }}>₦ 100,000</td>
              </tr>
              <tr>
                <td style={{ padding: "0.75rem 0", color: "rgb(var(--color-text))", fontWeight: "600" }}>HR & Talent</td>
                <td style={{ textAlign: "right", fontWeight: "700", color: "rgb(var(--color-text))" }}>₦ 650,000</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="glass-panel" style={{ padding: "1.5rem", backgroundColor: "rgb(var(--color-card))", borderRadius: "0.75rem" }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-around", height: "140px", paddingTop: "1rem", borderBottom: "1px solid rgba(255, 255, 255, 0.1)" }}>
            {["Jan", "Feb", "Mar", "Apr", "May", "Jun"].map((m, idx) => (
              <span key={idx} style={{ fontSize: "0.75rem", color: "rgb(var(--color-text-muted))", fontWeight: "600" }}>{m}</span>
            ))}
          </div>
        </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                ...
                <div>
                  <div style={{ fontWeight: "700", color: "rgb(var(--color-text))", fontSize: "0.85rem" }}>Travel & Flights</div>
                  <div style={{ fontSize: "0.75rem", color: "rgb(var(--color-text-muted))" }}>24 Requests</div>
                </div>
              </div>
              <span style={{ fontWeight: "700", color: "rgb(var(--color-text))", fontSize: "0.9rem" }}>₦ 1.2M</span>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                ...
                <div>
                  <div style={{ fontWeight: "700", color: "rgb(var(--color-text))", fontSize: "0.85rem" }}>SaaS Subscriptions</div>
                  <div style={{ fontSize: "0.75rem", color: "rgb(var(--color-text-muted))" }}>18 Requests</div>
                </div>
              </div>
              <span style={{ fontWeight: "700", color: "rgb(var(--color-text))", fontSize: "0.9rem" }}>₦ 850k</span>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                ...
                <div>
                  <div style={{ fontWeight: "700", color: "rgb(var(--color-text))", fontSize: "0.85rem" }}>Client Entertainment</div>
                  <div style={{ fontSize: "0.75rem", color: "rgb(var(--color-text-muted))" }}>12 Requests</div>
                </div>
              </div>
              <span style={{ fontWeight: "700", color: "rgb(var(--color-text))", fontSize: "0.9rem" }}>₦ 420k</span>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                ...
                <div>
                  <div style={{ fontWeight: "700", color: "rgb(var(--color-text))", fontSize: "0.85rem" }}>Office Supplies</div>
                  <div style={{ fontSize: "0.75rem", color: "rgb(var(--color-text-muted))" }}>32 Requests</div>
                </div>
              </div>
              <span style={{ fontWeight: "700", color: "rgb(var(--color-text))", fontSize: "0.9rem" }}>₦ 180k</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "1.25rem" }}>
          <div style={{ backgroundColor: "rgba(15, 23, 42, 0.6)", border: "1px solid rgba(255, 255, 255, 0.08)", borderRadius: "0.5rem", padding: "1rem", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div style={{ display: "flex", gap: "0.75rem", alignItems: "center" }}>
              ...
              <div>
                <div style={{ fontWeight: "700", color: "rgb(var(--color-text))", fontSize: "0.85rem" }}>Adewale Tinubu</div>
                <div style={{ fontSize: "0.75rem", color: "rgb(var(--color-text-muted))" }}>Engineering</div>
              </div>
            </div>
            <div style={{ textAlign: "right" }}>
              <div style={{ fontWeight: "800", color: "rgb(var(--color-text))", fontSize: "0.9rem" }}>₦640,400</div>
              <div style={{ fontSize: "0.72rem", color: "rgb(var(--color-text-muted))" }}>14 Requests</div>
            </div>
          </div>
          ...
          <div style={{ backgroundColor: "rgba(15, 23, 42, 0.6)", border: "1px solid rgba(255, 255, 255, 0.08)", borderRadius: "0.5rem", padding: "1rem", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div style={{ display: "flex", gap: "0.75rem", alignItems: "center" }}>
              ...
              <div>
                <div style={{ fontWeight: "700", color: "rgb(var(--color-text))", fontSize: "0.85rem" }}>Chioma Okeke</div>
                <div style={{ fontSize: "0.75rem", color: "rgb(var(--color-text-muted))" }}>Marketing</div>
              </div>
            </div>
            <div style={{ textAlign: "right" }}>
              <div style={{ fontWeight: "800", color: "rgb(var(--color-text))", fontSize: "0.9rem" }}>₦320,000</div>
              <div style={{ fontSize: "0.72rem", color: "rgb(var(--color-text-muted))" }}>11 Requests</div>
            </div>
          </div>
          ...
          <div style={{ backgroundColor: "rgba(15, 23, 42, 0.6)", border: "1px solid rgba(255, 255, 255, 0.08)", borderRadius: "0.5rem", padding: "1rem", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div style={{ display: "flex", gap: "0.75rem", alignItems: "center" }}>
              ...
              <div>
                <div style={{ fontWeight: "700", color: "rgb(var(--color-text))", fontSize: "0.85rem" }}>Blessing Okafor</div>
                <div style={{ fontSize: "0.75rem", color: "rgb(var(--color-text-muted))" }}>Operations</div>
              </div>
            </div>
            <div style={{ textAlign: "right" }}>
              <div style={{ fontWeight: "800", color: "rgb(var(--color-text))", fontSize: "0.9rem" }}>₦890,000</div>
              <div style={{ fontSize: "0.72rem", color: "rgb(var(--color-text-muted))" }}>9 Requests</div>
            </div>
          </div>
          ...
          <div style={{ backgroundColor: "rgba(15, 23, 42, 0.6)", border: "1px solid rgba(255, 255, 255, 0.08)", borderRadius: "0.5rem", padding: "1rem", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div style={{ display: "flex", gap: "0.75rem", alignItems: "center" }}>
              ...
              <div>
                <div style={{ fontWeight: "700", color: "rgb(var(--color-text))", fontSize: "0.85rem" }}>Fatima Musa</div>
                <div style={{ fontSize: "0.75rem", color: "rgb(var(--color-text-muted))" }}>Sales</div>
              </div>
            </div>
            <div style={{ textAlign: "right" }}>
              <div style={{ fontWeight: "800", color: "rgb(var(--color-text))", fontSize: "0.9rem" }}>₦210,000</div>
              <div style={{ fontSize: "0.72rem", color: "rgb(var(--color-text-muted))" }}>8 Requests</div>
            </div>
          </div>
        </div>
      </div>
